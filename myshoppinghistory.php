...
<body>
	...
	<div class="leftwrapper">
		...
		<div class="myshoppinghistory"> 
			...
			<div class="book1">
				<p>Book name:</p><p>Author &nbsp &nbsp &nbsp &nbsp:</p><p>Publish by :</p><p>Rating&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:</p><p>View&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:</p><p>Price&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:</p><p>Date&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:</p>
			</div>
			<div class="image2">
				<img src="./images/banner.jpg" width="108px" height="144px">
			</div>
