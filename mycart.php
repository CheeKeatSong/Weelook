	...
	<div class="leftwrapper">
		...
		<div class="middlewrapper2"> 
			...
			<div class="result1">
				...
				<input type="button" value="Checkout" class="checkoutbutton" action="http://localhost/sck/checkout.php">
			...
			<div class="book1">
				<p>Book name: The lord of the Rings</p><p>Author &nbsp &nbsp &nbsp &nbsp: J.R.R.Tolkien</p>	<p>Rating&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp: 4.40</p><p>View&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp: 1200</p><p>Price&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp: RM90.00</p><p>Quantity&nbsp&nbsp&nbsp&nbsp&nbsp: 3</p>
			</div>
			<div class="image2">
				<img src="./images/banner.jpg" width="108px" height="144px">
			</div>
			<div class="book2">
				<p>Book name:</p><p>Author &nbsp &nbsp &nbsp &nbsp:</p><p>Rating&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:</p><p>View&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:</p><p>Price&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:</p><p>Quantity&nbsp&nbsp&nbsp&nbsp&nbsp:</p>
			</div>
			<div class="image3">
				<img src="./images/banner.jpg" width="108px" height="144px">
			</div>
